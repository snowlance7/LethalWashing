...
namespace LethalWashing
{
    ...
    internal class TESTING : MonoBehaviour
    {
        ...
        public static void SubmitChat_performedPrefix(HUDManager __instance)
        {
            ...
            {
                case "/spawn":
                    GameObject.Instantiate(PluginInstance.WashingMachineRef.spawnableMapObject.prefabToSpawn, localPlayer.transform.forward * 2f, Quaternion.identity).GetComponent<NetworkObject>().Spawn(true);
                    break;
                case "/enemies":
